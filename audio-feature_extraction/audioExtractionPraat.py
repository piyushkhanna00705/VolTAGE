...
for file in tqdm(files):
    ...
    with open('./pklFiles/audio_featDict.pkl', 'rb') as f:
    ...
    for aud_file in os.listdir(audio_folder):
        ...
        with open('./pklFiles/audio_featDict.pkl', 'wb') as f:
...
for file in tqdm(files):
    ...
    with open('./pklFiles/audio_featDictMark2.pkl', 'rb') as f:
    ...
    for aud_file in os.listdir(audio_folder):
        ...
        with open('./pklFiles/audio_featDictMark2.pkl', 'wb') as f:
